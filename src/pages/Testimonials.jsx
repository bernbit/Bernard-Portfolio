...
function Testimonials() {
  ...
  return (
    <section
      ...
      ref={testimonialRef}
    >
      <div className="mb-20 pb-5 text-center">
      ...
      <div className="mt-7 flex flex-col gap-20 md:flex-row md:gap-7">
        {testimonies.map((testimony, index) => (
          <div
            className="relative basis-1/2 rounded-md border border-extra bg-tertiary shadow-custom dark:border-none dark:bg-dark-tertiary dark:shadow-none"
            key={index}
          >
            {/* Avatar */}
