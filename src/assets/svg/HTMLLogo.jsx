...
function HTMLLogo({ width, height, circle }) {
  return (
    <svg
    ...
    >
      ...
      <g clipPath="url(#clip0_78_85)">
        ...
        <path
          fill="#fff"
          d="M30.7 33.327H52.27l-.65 6.003H31.168l1.338 17.115L44.5 60.247l11.993-3.802.7-8.942h-6.296v4.386l-6.565 1.762-6.526-1.762-.507-6.99h20.097l1.334-17.07H30.27l.43 5.498z"
        ></path>
      </g>
      <defs>
