...
function JSLogo({ width, height, circle }) {
  return (
    <svg
    ...
    >
      ...
      <g clipPath="url(#clip0_78_99)">
        ...
        <path
          fill="#fff"
          d="M42.459 59.76l-10.795-2.154-.68-7.481h4.101l.37 4.075 2.92.582V27.667h4.083V59.76zM59.685 31.75h-9.06v10.209h8.133l-1.422 15.647-10.794 2.155v-4.163l7.002-1.398.742-8.158H46.54V27.667h13.515l-.37 4.083z"
        ></path>
      </g>
      <defs>
